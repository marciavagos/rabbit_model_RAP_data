...
params_rap=/Users/marciavagos/Documents/RAP_paper/data/params_RAP.txt
ramm_file=/Users/marciavagos/repos/Rabbit_model/source_v6/RAMM_v6.out

for model in "${array[@]}"
do
  cp /Users/marciavagos/Documents/RAP_paper/data/Parameters_2.txt ./Parameters_"$model".txt
  ...
  sed -i '' 's/ICaL_junc_scl=ICaL_junc_scl/ICaL_junc_scl='"${p2[0]}"'/' Parameters_$model.txt
  sed -i '' 's/ICaL_sl_scl=ICaL_sl_scl/ICaL_sl_scl='"${p2[0]}"'/' Parameters_$model.txt
  ...
  sed -i '' 's/INaCa_junc_scl=INaCa_junc_scl/INaCa_junc_scl='"${p2[3]}"'/' Parameters_$model.txt
  sed -i '' 's/INaCa_sl_scl=INaCa_sl_scl/INaCa_sl_scl='"${p2[3]}"'/' Parameters_$model.txt
